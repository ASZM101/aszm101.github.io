...
document.querySelector('header').innerHTML = `
    ...
    <nav>
        ...
        <a href="contact.html" target="_blank"><img src="assets/img/contact.png" alt="Open envelope" title="Contact"></a>
        <a href="resume.pdf" target="_blank"><img src="assets/img/resume.png" alt="Briefcase" title="Resume"></a>
    </nav>
`;
